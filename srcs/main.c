...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/03/22 13:24:11 by pkerckho          #+#    #+#             */
/*   Updated: 2016/03/22 16:42:18 by pkerckho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
			...
			|| (!(ft_strcmp(m.argv, "burningship")))))
	{
		...
		mlx_string_put(m.mlx, m.win, 460, 230, 0x009999FF, HELLO);
		mlx_string_put(m.mlx, m.win, 450, 280, 0x009999FF, START);
		ft_fractol_init(&m);
